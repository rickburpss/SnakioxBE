...
export const flagBotWallet = selectedStore.flagBotWallet;
export const listBotFlags = selectedStore.listBotFlags;
export const removeBotFlag = selectedStore.removeBotFlag;
export const isWalletFlaggedBot = selectedStore.isWalletFlaggedBot;
